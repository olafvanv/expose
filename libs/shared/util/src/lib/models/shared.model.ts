 ...
 */
export type ShutterSpeed = (typeof shutterSpeedOptions)[number];
 ...
 */
export type Aperture = (typeof apertureOptions)[number];

export const apertureOptions = [1.0, 1.4, 2, 2.8, 4, 5.6, 8, 11, 16, 22, 32] as const;
...
export const isoOptions = [25, 50, 64, 100, 125, 160, 200, 400, 800, 1600, 3200, 6400, 12800] as const;

export type IsoValue = (typeof isoOptions)[number];
