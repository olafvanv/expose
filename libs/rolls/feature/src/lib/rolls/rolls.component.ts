...
import { lucideEdit3, lucideFilm, lucideInfo, lucidePlus, lucideTrash2 } from '@ng-icons/lucide';
...
export class RollsComponent implements OnInit {
  ...
  public async onDelete(id: string, event: MouseEvent): Promise<void> {
    event.stopPropagation();
    if (
      confirm('Are you sure you want to delete this film roll? All related photos will remain but their roll reference will be cleared.')
    ) {
